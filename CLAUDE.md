...
Learning project: a wallet/ledger backend supporting top-ups, wallet-to-wallet
transfers, and wallet-to-bank transfers (mocked). Full requirements and system
design live in `docs/wallet-service-design.docx` — this file summarizes it so
day-to-day work doesn't require opening the doc.
